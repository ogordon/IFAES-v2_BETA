/*
 *
 * View Class to manage Infoexpo Page
 *
 */


window.InfoexpoView = Backbone.View.extend({
  initialize:function () {
    //this.template = _.template(tpl.get('infoexpo'));
    this.template = _.template($('#infoexpo').html());
